...
output acrServerName string = createACR ? acrDeployment.properties.loginServer : ''
output acrUsername string = createACR ? acrDeployment.name : ''
output acrPassword string = createACR ? listCredentials(acrDeployment.id, acrDeployment.apiVersion).passwords[0].value : ''
